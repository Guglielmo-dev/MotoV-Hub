  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Dialog open={isMaintOpen} onOpenChange={setIsMaintOpen}>
          ...
          <DialogContent className="bg-card border-white/10 text-foreground">
            <DialogHeader className="pr-8"><DialogTitle>Log Maintenance</DialogTitle></DialogHeader>
            <form onSubmit={e => {
              e.preventDefault();
      ...
      {maintenance?.length === 0 ? (
        <div className="text-center py-12 text-muted-foreground bg-card/80 backdrop-blur-md border border-white/5 rounded-2xl">No maintenance records found.</div>
      ) : (
